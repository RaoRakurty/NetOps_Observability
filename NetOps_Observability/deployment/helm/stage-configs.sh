...
MAP=(
    ...
    "src/config/vmscrape-mtls.yml|config/vmscrape-mtls.yml"
    ...
    "deployment/docker/gnmic/gnmic-correlation.yaml|gnmic/gnmic-correlation.yaml"
    ...
    "deployment/docker/syslog-ng/core.conf|syslog-ng/core.conf"
    "deployment/docker/syslog-ng/syslog-ng-tls.conf|syslog-ng/syslog-ng-tls.conf"
