# AWS — Firewall block  (scenario `DAWS4`)

Fill during the live capture window. Exact commands: **`../../RUNBOOK.md`**
→ "Scenario 4 — Firewall block" (AWS block).
## What changed
...
- [ ] `03-correlix-signal.png` — `./capture-scenario.sh aws 4-firewall signal` (or log-lane zoom)
- [ ] `04-correlix-rca.png` — `./capture-scenario.sh aws 4-firewall rca`
- [ ] `05-recovery.png` — `./capture-scenario.sh aws 4-firewall recovery` (post-revert + soak)
