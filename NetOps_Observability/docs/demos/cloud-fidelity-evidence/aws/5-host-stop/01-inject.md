...
- [ ] `03-correlix-signal.png` — `./capture-scenario.sh aws 5-host-stop signal` (or log-lane zoom)
- [ ] `04-correlix-rca.png` — `./capture-scenario.sh aws 5-host-stop rca`
- [ ] `05-recovery.png` — `./capture-scenario.sh aws 5-host-stop recovery` (post-revert + soak)
