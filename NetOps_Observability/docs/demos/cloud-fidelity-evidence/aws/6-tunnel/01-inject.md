# AWS — Tunnel / underlay fault  (scenario `DAWS6`)

Fill during the live capture window. Exact commands: **`../../RUNBOOK.md`**
→ "Scenario 6 — Tunnel / underlay fault" (AWS block).
## What changed
...
- [ ] `03-correlix-signal.png` — `./capture-scenario.sh aws 6-tunnel signal` (or log-lane zoom)
- [ ] `04-correlix-rca.png` — `./capture-scenario.sh aws 6-tunnel rca`
- [ ] `05-recovery.png` — `./capture-scenario.sh aws 6-tunnel recovery` (post-revert + soak)
