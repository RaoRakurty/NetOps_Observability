# AWS — Console pivot  (scenario `DAWS7`)

Fill during the live capture window. Exact commands: **`../../RUNBOOK.md`**
→ "Scenario 7 — Console pivot" (AWS block).
## What changed
...
- [ ] `03-correlix-signal.png` — `./capture-scenario.sh aws 7-console-pivot signal` (or log-lane zoom)
- [ ] `04-correlix-rca.png` — `./capture-scenario.sh aws 7-console-pivot rca`
- [ ] `05-recovery.png` — `./capture-scenario.sh aws 7-console-pivot recovery` (post-revert + soak)
