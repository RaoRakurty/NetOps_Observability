# Azure — WAF misfire  (scenario `DAZURE2`)

Fill during the live capture window. Exact commands: **`../../RUNBOOK.md`**
→ "Scenario 2 — WAF misfire" (Azure block).
## What changed
...
- [ ] `03-correlix-signal.png` — `./capture-scenario.sh azure 2-waf signal` (or log-lane zoom)
- [ ] `04-correlix-rca.png` — `./capture-scenario.sh azure 2-waf rca`
- [ ] `05-recovery.png` — `./capture-scenario.sh azure 2-waf recovery` (post-revert + soak)
