# Azure — Tunnel / underlay fault  (scenario `DAZURE6`)

Fill during the live capture window. Exact commands: **`../../RUNBOOK.md`**
→ "Scenario 6 — Tunnel / underlay fault" (Azure block).
## What changed
...
- [ ] `03-correlix-signal.png` — `./capture-scenario.sh azure 6-tunnel signal` (or log-lane zoom)
- [ ] `04-correlix-rca.png` — `./capture-scenario.sh azure 6-tunnel rca`
- [ ] `05-recovery.png` — `./capture-scenario.sh azure 6-tunnel recovery` (post-revert + soak)
