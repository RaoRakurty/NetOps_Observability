# GCP — Firewall block  (scenario `DGCP4`)

Fill during the live capture window. Exact commands: **`../../RUNBOOK.md`**
→ "Scenario 4 — Firewall block" (GCP block).
## What changed
...
- [ ] `03-correlix-signal.png` — `./capture-scenario.sh gcp 4-firewall signal` (or log-lane zoom)
- [ ] `04-correlix-rca.png` — `./capture-scenario.sh gcp 4-firewall rca`
- [ ] `05-recovery.png` — `./capture-scenario.sh gcp 4-firewall recovery` (post-revert + soak)
