# GCP — Console pivot  (scenario `DGCP7`)

Fill during the live capture window. Exact commands: **`../../RUNBOOK.md`**
→ "Scenario 7 — Console pivot" (GCP block).
## What changed
...
- [ ] `03-correlix-signal.png` — `./capture-scenario.sh gcp 7-console-pivot signal` (or log-lane zoom)
- [ ] `04-correlix-rca.png` — `./capture-scenario.sh gcp 7-console-pivot rca`
- [ ] `05-recovery.png` — `./capture-scenario.sh gcp 7-console-pivot recovery` (post-revert + soak)
