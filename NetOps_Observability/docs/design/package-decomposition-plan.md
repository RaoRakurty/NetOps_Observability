...
**Status:** forty-eight domains shipped (`internal/chschema`, `internal/openapi`,
...
`ticketing/worker`, `internal/selfheal`, 2026-07-28).
**212** non-test files remain in `package main`. This document is the ordered sequence for the
rest.
