...
**Status:** thirty-eight domains shipped (`internal/chschema`, `internal/openapi`,
...
`internal/discovery`, 2026-07-28).
**226** non-test files remain in `package main`. This document is the ordered sequence for the
rest.
