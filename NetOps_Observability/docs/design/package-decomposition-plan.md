...
**Status:** thirty-five domains shipped (`internal/chschema`, `internal/openapi`,
...
`appid/appstore`, 2026-07-28).
**230** non-test files remain in `package main`. This document is the ordered sequence for the
rest.
