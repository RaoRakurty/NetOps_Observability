...
`compliancemodel.FrameworkPack` data through the assembly seam
(`docs/design/LICENSING_MODEL_2026-09-04.md` §10, 2026-09-06). With that module absent the framework stays selectable and reports
