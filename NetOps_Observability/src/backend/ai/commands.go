...
var commands = []Command{
	...
	{Command: "/top", Aliases: []string{"/top-incident", "/top-incidents"}, Label: "Explain the top incident",
		Description: "Resolve the highest-priority incident from the queue and explain it.",
		Intent:      "top_incident", RiskLevel: "read_only", canonical: "explain the top incident"},
	{Command: "/focus", Aliases: []string{"/prioritize"}, Label: "What to focus on first",
		Description: "Which incident the NOC should work first, and why.",
		Intent:      "noc_focus", RiskLevel: "read_only", canonical: "which incident should the NOC focus on first and why"},
	{Command: "/breakdown", Aliases: []string{"/suspected"}, Label: "Suspected vs watch items",
		Description: "Separate active suspected incidents from undetermined watch items.",
		Intent:      "incident_breakdown", RiskLevel: "read_only", canonical: "show me active suspected incidents and separate them from undetermined watch items"},
