-- Rollback for 0042_security_framework_state.sql.
DROP TABLE IF EXISTS security_framework_state;
...
DELETE FROM schema_migrations WHERE version = '0042_security_framework_state.sql';
