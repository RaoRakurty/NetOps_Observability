...
func fixtureSnapshot(t *testing.T, name string, rep Report) {
	t.Helper()
...
func buildFixtureP3335CF(t *testing.T) Report {
	t.Helper()
...
func buildFixturePD96E4C(t *testing.T) Report {
	t.Helper()
...
func TestFixturePD96E4CStaysValidationAssessment(t *testing.T) {
	...
	rep.Promotion = EvaluatePromotion(&rep, &rec)
