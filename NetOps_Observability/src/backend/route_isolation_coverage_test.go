...
var isolationCoverageBaseline = map[string]string{
	...
	"/api/appid/status":                        "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	"/api/applications":                        "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	"/api/applications/":                       "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	...
	"/api/correlations/undetermined-frequency": "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	"/api/credentials":                         "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	...
	"/api/itsm/pagerduty-rca":                  "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	"/api/itsm/servicenow":                     "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	"/api/itsm/slack-rca":                      "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	...
	"/api/metrics":                             "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	"/api/metrics/forecast":                    "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	...
	"/api/reports/channels":                    "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	...
	"/api/reports/runs":                        "store/RLS-scoped; dedicated HTTP isolation test is backlog",
	...
	"/api/topology/graph":                      "store/RLS-scoped; dedicated HTTP isolation test is backlog",
