...
const TEMPLATES: Template[] = [
  ...
  { id: "ifutil", category: "Interfaces", title: "Interface utilization", desc: "Inbound bandwidth as a share of line speed.", expr: `rate(device_if_in_octets{S}[5m]) * 8 * 100 / device_if_speed{S} > {T}`, threshold: 90, unit: "%", forSec: 300, severity: "warning", nameHint: "InterfaceUtilization" },
  // Routing
