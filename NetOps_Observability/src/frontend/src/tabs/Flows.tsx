    ...
    <>
      ...
      <div className="panel">
        ...
        <p className="mini-meta" style={{ margin: 0 }}>
          ...
          <a href="#/analytics/device-monitoring" style={{ color: "var(--accent)", fontWeight: 500 }}>Device Monitoring</a> and{" "}
          <a href="#/analytics/interface-performance" style={{ color: "var(--accent)", fontWeight: 500 }}>Interface Performance</a>.
        </p>
      </div>
    </>
  );
